...
export const PATHS = {
  ...
  admin_pregnant_treatment_types_edit: "/admin/types/pregnanttreatmenttypes/:code/edit",
  ...
  admin_delivery_result_types_edit: "/admin/types/deliveryresulttypes/:code/edit",
