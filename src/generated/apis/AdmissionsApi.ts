...
export class AdmissionsApi extends BaseAPI {
	/**
	 */
	deleteAdmissionType1({
		id,
	}: DeleteAdmissionType1Request): Observable<boolean>;
	deleteAdmissionType1(
		{ id }: DeleteAdmissionType1Request,
		opts?: OperationOpts,
	...
	dischargePatient({
		patientCode,
		admissionDTO,
	}: DischargePatientRequest): Observable<boolean>;
	dischargePatient(
		{ patientCode, admissionDTO }: DischargePatientRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	dischargePatient(
		{ patientCode, admissionDTO }: DischargePatientRequest,
	...
	getAdmissions({
		...
		size,
		paged,
	}: GetAdmissionsRequest): Observable<PageAdmissionDTO>;
	getAdmissions(
		{ admissionrange, page, size, paged }: GetAdmissionsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PageAdmissionDTO>>;
	getAdmissions(
		{ admissionrange, page, size, paged }: GetAdmissionsRequest,
		opts?: OperationOpts,
	): Observable<PageAdmissionDTO | AjaxResponse<PageAdmissionDTO>> {
	...
	getAdmissions1({
		patientCode,
	}: GetAdmissions1Request): Observable<Array<AdmissionDTO>>;
	getAdmissions1(
		{ patientCode }: GetAdmissions1Request,
		opts?: OperationOpts,
	...
	getAdmittedPatients({
		...
		admissionrange,
		dischargerange,
	}: GetAdmittedPatientsRequest): Observable<Array<AdmittedPatientDTO>>;
	getAdmittedPatients(
		{ searchterms, admissionrange, dischargerange }: GetAdmittedPatientsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<AdmittedPatientDTO>>>;
	getAdmittedPatients(
		{ searchterms, admissionrange, dischargerange }: GetAdmittedPatientsRequest,
		opts?: OperationOpts,
	): Observable<
		Array<AdmittedPatientDTO> | AjaxResponse<Array<AdmittedPatientDTO>>
	> {
		const headers: HttpHeaders = {};
	...
	getCurrentAdmission({
		patientCode,
	}: GetCurrentAdmissionRequest): Observable<AdmissionDTO>;
	getCurrentAdmission(
		{ patientCode }: GetCurrentAdmissionRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<AdmissionDTO>>;
	getCurrentAdmission(
		{ patientCode }: GetCurrentAdmissionRequest,
		opts?: OperationOpts,
	): Observable<AdmissionDTO | AjaxResponse<AdmissionDTO>> {
	...
	getDischarges({
		...
		page,
		size,
	}: GetDischargesRequest): Observable<PageAdmissionDTO>;
	getDischarges(
		{ dischargerange, page, size }: GetDischargesRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PageAdmissionDTO>>;
	getDischarges(
		{ dischargerange, page, size }: GetDischargesRequest,
	...
	getNextYearProgressiveId({
		wardcode,
	}: GetNextYearProgressiveIdRequest): Observable<number>;
	getNextYearProgressiveId(
		{ wardcode }: GetNextYearProgressiveIdRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<number>>;
	getNextYearProgressiveId(
		{ wardcode }: GetNextYearProgressiveIdRequest,
		opts?: OperationOpts,
	...
	newAdmissions({
		admissionDTO,
	}: NewAdmissionsRequest): Observable<AdmissionDTO>;
	newAdmissions(
		{ admissionDTO }: NewAdmissionsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<AdmissionDTO>>;
	newAdmissions(
		{ admissionDTO }: NewAdmissionsRequest,
	...
	updateAdmissions({
		admissionDTO,
	}: UpdateAdmissionsRequest): Observable<AdmissionDTO>;
	updateAdmissions(
		{ admissionDTO }: UpdateAdmissionsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<AdmissionDTO>>;
	updateAdmissions(
		{ admissionDTO }: UpdateAdmissionsRequest,
