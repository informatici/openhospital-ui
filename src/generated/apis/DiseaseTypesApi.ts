...
import type { DiseaseTypeDTO } from '../models';
...
export class DiseaseTypesApi extends BaseAPI {
	...
	getAllDiseaseTypes(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DiseaseTypeDTO>>>;
	getAllDiseaseTypes(
		opts?: OperationOpts,
	): Observable<Array<DiseaseTypeDTO> | AjaxResponse<Array<DiseaseTypeDTO>>> {
		const headers: HttpHeaders = {};
	...
	newDiseaseType({
		diseaseTypeDTO,
	}: NewDiseaseTypeRequest): Observable<DiseaseTypeDTO>;
	newDiseaseType(
		{ diseaseTypeDTO }: NewDiseaseTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DiseaseTypeDTO>>;
	newDiseaseType(
		{ diseaseTypeDTO }: NewDiseaseTypeRequest,
		opts?: OperationOpts,
	): Observable<DiseaseTypeDTO | AjaxResponse<DiseaseTypeDTO>> {
	...
	updateDiseaseType({
		diseaseTypeDTO,
	}: UpdateDiseaseTypeRequest): Observable<DiseaseTypeDTO>;
	updateDiseaseType(
		{ diseaseTypeDTO }: UpdateDiseaseTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DiseaseTypeDTO>>;
	updateDiseaseType(
		{ diseaseTypeDTO }: UpdateDiseaseTypeRequest,
