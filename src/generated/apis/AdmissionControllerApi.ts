...
import { AdmissionDTO, AdmittedPatientDTO } from "../models";
...
export class AdmissionControllerApi extends BaseAPI {
  ...
  getAdmissionsUsingGET({
    id,
  }: GetAdmissionsUsingGETRequest): Observable<AdmissionDTO>;
  getAdmissionsUsingGET(
    { id }: GetAdmissionsUsingGETRequest,
    opts?: OperationOpts
  ...
  getPatientAdmissionsUsingGET({
    patientcode,
  }: GetPatientAdmissionsUsingGETRequest): Observable<Array<AdmissionDTO>>;
  getPatientAdmissionsUsingGET(
    { patientcode }: GetPatientAdmissionsUsingGETRequest,
    opts?: OperationOpts
  ...
  newAdmissionsUsingPOST({
    newAdmissionDTO,
  }: NewAdmissionsUsingPOSTRequest): Observable<number>;
  newAdmissionsUsingPOST(
  ...
  updateAdmissionsUsingPUT({
    updAdmissionDTO,
  }: UpdateAdmissionsUsingPUTRequest): Observable<number>;
  updateAdmissionsUsingPUT(
    { updAdmissionDTO }: UpdateAdmissionsUsingPUTRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<number>>;
  updateAdmissionsUsingPUT(
    { updAdmissionDTO }: UpdateAdmissionsUsingPUTRequest,
