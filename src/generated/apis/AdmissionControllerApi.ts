...
import { AdmissionDTO, AdmittedPatientDTO, PageAdmissionDTO } from "../models";
...
export class AdmissionControllerApi extends BaseAPI {
  ...
  deleteAdmissionTypeUsingDELETE({
    id,
  }: DeleteAdmissionTypeUsingDELETERequest): Observable<boolean>;
  deleteAdmissionTypeUsingDELETE(
    { id }: DeleteAdmissionTypeUsingDELETERequest,
    opts?: OperationOpts
   ...
   * dischargePatient
   */
  dischargePatientUsingPOST({
    patientCode,
    currentAdmissionDTO,
  }: DischargePatientUsingPOSTRequest): Observable<boolean>;
  dischargePatientUsingPOST(
    { patientCode, currentAdmissionDTO }: DischargePatientUsingPOSTRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<boolean>>;
  dischargePatientUsingPOST(
    { patientCode, currentAdmissionDTO }: DischargePatientUsingPOSTRequest,
  ...
  getAdmissionsUsingGET({
    patientCode,
  }: GetAdmissionsUsingGETRequest): Observable<Array<AdmissionDTO>>;
  getAdmissionsUsingGET(
    { patientCode }: GetAdmissionsUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<Array<AdmissionDTO>>>;
  getAdmissionsUsingGET(
    { patientCode }: GetAdmissionsUsingGETRequest,
    opts?: OperationOpts
  ): Observable<Array<AdmissionDTO> | RawAjaxResponse<Array<AdmissionDTO>>> {
    ...
    return this.request<Array<AdmissionDTO>>(
      {
        url: "/admissions/patient/{patientCode}".replace(
          "{patientCode}",
  ...
  getAdmissionsUsingGET1({
    ...
    page,
    size,
  }: GetAdmissionsUsingGET1Request): Observable<PageAdmissionDTO>;
  getAdmissionsUsingGET1(
    { admissionrange, page, size }: GetAdmissionsUsingGET1Request,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<PageAdmissionDTO>>;
  getAdmissionsUsingGET1(
    { admissionrange, page, size }: GetAdmissionsUsingGET1Request,
    opts?: OperationOpts
  ): Observable<PageAdmissionDTO | RawAjaxResponse<PageAdmissionDTO>> {
    throwIfNullOrUndefined(
      admissionrange,
      "admissionrange",
      "getAdmissionsUsingGET1"
  ...
  getAdmittedPatientsUsingGET({
    ...
    dischargerange,
    searchterms,
  }: GetAdmittedPatientsUsingGETRequest): Observable<Array<AdmittedPatientDTO>>;
  getAdmittedPatientsUsingGET(
    {
      admissionrange,
      dischargerange,
      searchterms,
    }: GetAdmittedPatientsUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<Array<AdmittedPatientDTO>>>;
  getAdmittedPatientsUsingGET(
    {
      admissionrange,
      dischargerange,
    ...
    Array<AdmittedPatientDTO> | RawAjaxResponse<Array<AdmittedPatientDTO>>
  > {
    const headers: HttpHeaders = {
      ...(this.configuration.apiKey && {
        Authorization: this.configuration.apiKey("Authorization"),
    ...
    if (admissionrange != null) {
      query["admissionrange"] = admissionrange.join(COLLECTION_FORMATS["csv"]);
    }
    if (dischargerange != null) {
      query["dischargerange"] = dischargerange.join(COLLECTION_FORMATS["csv"]);
    }
    if (searchterms != null) {
  ...
  getCurrentAdmissionUsingGET({
    patientCode,
  }: GetCurrentAdmissionUsingGETRequest): Observable<AdmissionDTO>;
  getCurrentAdmissionUsingGET(
    { patientCode }: GetCurrentAdmissionUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<AdmissionDTO>>;
  getCurrentAdmissionUsingGET(
    { patientCode }: GetCurrentAdmissionUsingGETRequest,
    opts?: OperationOpts
  ): Observable<AdmissionDTO | RawAjaxResponse<AdmissionDTO>> {
    throwIfNullOrUndefined(
      patientCode,
      "patientCode",
      "getCurrentAdmissionUsingGET"
  ...
  getDischargesUsingGET({
    ...
    page,
    size,
  }: GetDischargesUsingGETRequest): Observable<PageAdmissionDTO>;
  getDischargesUsingGET(
    { dischargerange, page, size }: GetDischargesUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<PageAdmissionDTO>>;
  getDischargesUsingGET(
    { dischargerange, page, size }: GetDischargesUsingGETRequest,
  ...
  getNextYProgUsingGET({
    wardcode,
  }: GetNextYProgUsingGETRequest): Observable<number>;
  getNextYProgUsingGET(
    { wardcode }: GetNextYProgUsingGETRequest,
    opts?: OperationOpts
  ...
  getUsedWardBedUsingGET({
    wardid,
  }: GetUsedWardBedUsingGETRequest): Observable<number>;
  getUsedWardBedUsingGET(
  ...
  newAdmissionsUsingPOST({
    newAdmissionDTO,
  }: NewAdmissionsUsingPOSTRequest): Observable<AdmissionDTO>;
  newAdmissionsUsingPOST(
    { newAdmissionDTO }: NewAdmissionsUsingPOSTRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<AdmissionDTO>>;
  newAdmissionsUsingPOST(
    { newAdmissionDTO }: NewAdmissionsUsingPOSTRequest,
  ...
  updateAdmissionsUsingPUT({
    updateAdmissionDTO,
  }: UpdateAdmissionsUsingPUTRequest): Observable<AdmissionDTO>;
  updateAdmissionsUsingPUT(
    { updateAdmissionDTO }: UpdateAdmissionsUsingPUTRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<AdmissionDTO>>;
  updateAdmissionsUsingPUT(
    { updateAdmissionDTO }: UpdateAdmissionsUsingPUTRequest,
