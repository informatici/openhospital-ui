...
import type { VaccineTypeDTO } from '../models';
...
export class VaccineTypeApi extends BaseAPI {
	...
	checkVaccineTypeCode({
		code,
	}: CheckVaccineTypeCodeRequest): Observable<boolean>;
	checkVaccineTypeCode(
		{ code }: CheckVaccineTypeCodeRequest,
		opts?: OperationOpts,
	...
	getVaccineType(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<VaccineTypeDTO>>>;
	getVaccineType(
		opts?: OperationOpts,
	): Observable<Array<VaccineTypeDTO> | AjaxResponse<Array<VaccineTypeDTO>>> {
		const headers: HttpHeaders = {};
	...
	newVaccineType({
		vaccineTypeDTO,
	}: NewVaccineTypeRequest): Observable<VaccineTypeDTO>;
	newVaccineType(
		{ vaccineTypeDTO }: NewVaccineTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<VaccineTypeDTO>>;
	newVaccineType(
		{ vaccineTypeDTO }: NewVaccineTypeRequest,
		opts?: OperationOpts,
	): Observable<VaccineTypeDTO | AjaxResponse<VaccineTypeDTO>> {
	...
	updateVaccineType({
		vaccineTypeDTO,
	}: UpdateVaccineTypeRequest): Observable<VaccineTypeDTO>;
	updateVaccineType(
		{ vaccineTypeDTO }: UpdateVaccineTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<VaccineTypeDTO>>;
	updateVaccineType(
		{ vaccineTypeDTO }: UpdateVaccineTypeRequest,
