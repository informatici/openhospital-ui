...
import type { LotDTO, MovementDTO } from '../models';
...
export class StockMovementsApi extends BaseAPI {
	...
	alertCriticalQuantity({
		medCode,
		qty,
	}: AlertCriticalQuantityRequest): Observable<boolean>;
	alertCriticalQuantity(
		{ medCode, qty }: AlertCriticalQuantityRequest,
		opts?: OperationOpts,
	...
	/**
	 */
	alertCriticalQuantity1({
		medCode,
		qty,
	}: AlertCriticalQuantity1Request): Observable<boolean>;
	alertCriticalQuantity1(
		{ medCode, qty }: AlertCriticalQuantity1Request,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	alertCriticalQuantity1(
		{ medCode, qty }: AlertCriticalQuantity1Request,
	...
	getLotByMedical({
		medCode,
	}: GetLotByMedicalRequest): Observable<Array<LotDTO>>;
	getLotByMedical(
		{ medCode }: GetLotByMedicalRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<LotDTO>>>;
	getLotByMedical(
		{ medCode }: GetLotByMedicalRequest,
		opts?: OperationOpts,
	): Observable<Array<LotDTO> | AjaxResponse<Array<LotDTO>>> {
		...
		return this.request<Array<LotDTO>>(
			{
				url: '/stockmovements/lot/{med_code}'.replace(
					'{med_code}',
					encodeURI(medCode),
				),
				method: 'GET',
	...
	getLotByMedical1({
		medCode,
	}: GetLotByMedical1Request): Observable<Array<LotDTO>>;
	getLotByMedical1(
		{ medCode }: GetLotByMedical1Request,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<LotDTO>>>;
	getLotByMedical1(
		{ medCode }: GetLotByMedical1Request,
		...
		return this.request<Array<LotDTO>>(
			{
				url: '/medicalstockmovements/lot/{med_code}'.replace(
					'{med_code}',
					encodeURI(medCode),
				),
				method: 'GET',
	...
	getMovements(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<MovementDTO>>>;
	getMovements(
		opts?: OperationOpts,
	): Observable<Array<MovementDTO> | AjaxResponse<Array<MovementDTO>>> {
		const headers: HttpHeaders = {};
	...
	getMovements2({
		...
		lotDueFrom,
		lotDueTo,
	}: GetMovements2Request): Observable<Array<MovementDTO>>;
	getMovements2(
		{
			medCode,
			medType,
	...
	getMovements3({
		...
		from,
		to,
	}: GetMovements3Request): Observable<Array<MovementDTO>>;
	getMovements3(
		{ wardId, from, to }: GetMovements3Request,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<MovementDTO>>>;
	getMovements3(
		{ wardId, from, to }: GetMovements3Request,
	...
	getMovements6({
		...
		lotDueFrom,
		lotDueTo,
	}: GetMovements6Request): Observable<Array<MovementDTO>>;
	getMovements6(
		{
			medCode,
			medType,
	...
	getMovements7({
		...
		from,
		to,
	}: GetMovements7Request): Observable<Array<MovementDTO>>;
	getMovements7(
		{ wardId, from, to }: GetMovements7Request,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<MovementDTO>>>;
	getMovements7(
		{ wardId, from, to }: GetMovements7Request,
	...
	newMultipleChargingMovements({
		ref,
		movementDTO,
	}: NewMultipleChargingMovementsRequest): Observable<boolean>;
	newMultipleChargingMovements(
		{ ref, movementDTO }: NewMultipleChargingMovementsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	newMultipleChargingMovements(
		{ ref, movementDTO }: NewMultipleChargingMovementsRequest,
	...
	/**
	 */
	newMultipleChargingMovements1({
		ref,
		movementDTO,
	}: NewMultipleChargingMovements1Request): Observable<boolean>;
	newMultipleChargingMovements1(
		{ ref, movementDTO }: NewMultipleChargingMovements1Request,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	newMultipleChargingMovements1(
		{ ref, movementDTO }: NewMultipleChargingMovements1Request,
	...
	newMultipleDischargingMovements({
		ref,
		movementDTO,
	}: NewMultipleDischargingMovementsRequest): Observable<boolean>;
	newMultipleDischargingMovements(
		{ ref, movementDTO }: NewMultipleDischargingMovementsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	newMultipleDischargingMovements(
		{ ref, movementDTO }: NewMultipleDischargingMovementsRequest,
	...
	/**
	 */
	newMultipleDischargingMovements1({
		ref,
		movementDTO,
	}: NewMultipleDischargingMovements1Request): Observable<boolean>;
	newMultipleDischargingMovements1(
		{ ref, movementDTO }: NewMultipleDischargingMovements1Request,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	newMultipleDischargingMovements1(
		{ ref, movementDTO }: NewMultipleDischargingMovements1Request,
