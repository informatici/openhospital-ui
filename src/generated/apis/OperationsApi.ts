...
import type { OpdDTO, OperationDTO, OperationRowDTO } from '../models';
...
export class OperationsApi extends BaseAPI {
	...
	deleteOperationRow(
		{ code }: DeleteOperationRowRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	deleteOperationRow(
		{ code }: DeleteOperationRowRequest,
	...
	getOperationByCode({
		code,
	}: GetOperationByCodeRequest): Observable<OperationDTO>;
	getOperationByCode(
		{ code }: GetOperationByCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OperationDTO>>;
	getOperationByCode(
		{ code }: GetOperationByCodeRequest,
		opts?: OperationOpts,
	): Observable<OperationDTO | AjaxResponse<OperationDTO>> {
	...
	getOperationByTypeDescription({
		typeDescription,
	}: GetOperationByTypeDescriptionRequest): Observable<Array<OperationDTO>>;
	getOperationByTypeDescription(
		{ typeDescription }: GetOperationByTypeDescriptionRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<OperationDTO>>>;
	getOperationByTypeDescription(
		{ typeDescription }: GetOperationByTypeDescriptionRequest,
		opts?: OperationOpts,
	): Observable<Array<OperationDTO> | AjaxResponse<Array<OperationDTO>>> {
	...
	getOperationRowsByAdmt({
		admissionId,
	}: GetOperationRowsByAdmtRequest): Observable<Array<OperationRowDTO>>;
	getOperationRowsByAdmt(
		{ admissionId }: GetOperationRowsByAdmtRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<OperationRowDTO>>>;
	getOperationRowsByAdmt(
		{ admissionId }: GetOperationRowsByAdmtRequest,
		opts?: OperationOpts,
	): Observable<Array<OperationRowDTO> | AjaxResponse<Array<OperationRowDTO>>> {
		throwIfNullOrUndefined(
			admissionId,
			'admissionId',
			'getOperationRowsByAdmt',
	...
	getOperationRowsByOpd({
		opdDTO,
	}: GetOperationRowsByOpdRequest): Observable<Array<OperationRowDTO>>;
	getOperationRowsByOpd(
		{ opdDTO }: GetOperationRowsByOpdRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<OperationRowDTO>>>;
	getOperationRowsByOpd(
		{ opdDTO }: GetOperationRowsByOpdRequest,
	...
	getOperationRowsByPatient({
		patientCode,
	}: GetOperationRowsByPatientRequest): Observable<Array<OperationRowDTO>>;
	getOperationRowsByPatient(
		{ patientCode }: GetOperationRowsByPatientRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<OperationRowDTO>>>;
	getOperationRowsByPatient(
		{ patientCode }: GetOperationRowsByPatientRequest,
	...
	newOperation(
		{ operationDTO }: NewOperationRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OperationDTO>>;
	newOperation(
		{ operationDTO }: NewOperationRequest,
	...
	newOperationRow({
		operationRowDTO,
	}: NewOperationRowRequest): Observable<OperationRowDTO>;
	newOperationRow(
		{ operationRowDTO }: NewOperationRowRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OperationRowDTO>>;
	newOperationRow(
		{ operationRowDTO }: NewOperationRowRequest,
		opts?: OperationOpts,
	): Observable<OperationRowDTO | AjaxResponse<OperationRowDTO>> {
		throwIfNullOrUndefined(
			operationRowDTO,
			'operationRowDTO',
			'newOperationRow',
	...
	updateOperation({
		code,
		operationDTO,
	}: UpdateOperationRequest): Observable<OperationDTO>;
	updateOperation(
		{ code, operationDTO }: UpdateOperationRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OperationDTO>>;
	updateOperation(
		{ code, operationDTO }: UpdateOperationRequest,
	...
	updateOperationRow({
		operationRowDTO,
	}: UpdateOperationRowRequest): Observable<number>;
	updateOperationRow(
		{ operationRowDTO }: UpdateOperationRowRequest,
		opts?: OperationOpts,
