...
import type { MedicalWardDTO, MovementWardDTO } from '../models';
...
export class MedicalStockWardApi extends BaseAPI {
	...
	getCurrentQuantityInWard({
		wardCode,
		medId,
	}: GetCurrentQuantityInWardRequest): Observable<number>;
	getCurrentQuantityInWard(
		{ wardCode, medId }: GetCurrentQuantityInWardRequest,
		opts?: OperationOpts,
	...
	getCurrentQuantityInWard(
		...
		return this.request<number>(
			{
				url: '/medicalstockward/current/{ward_code}'.replace(
					'{ward_code}',
					encodeURI(wardCode),
				),
				method: 'GET',
	...
	getMedicalsWard({
		wardCode,
	}: GetMedicalsWardRequest): Observable<Array<MedicalWardDTO>>;
	getMedicalsWard(
		{ wardCode }: GetMedicalsWardRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<MedicalWardDTO>>>;
	getMedicalsWard(
		{ wardCode }: GetMedicalsWardRequest,
		opts?: OperationOpts,
	): Observable<Array<MedicalWardDTO> | AjaxResponse<Array<MedicalWardDTO>>> {
		...
		return this.request<Array<MedicalWardDTO>>(
			{
				url: '/medicalstockward/{ward_code}'.replace(
					'{ward_code}',
					encodeURI(wardCode),
				),
				method: 'GET',
	...
	getMovementWard({
		...
		from,
		to,
	}: GetMovementWardRequest): Observable<Array<MovementWardDTO>>;
	getMovementWard(
		{ wardCode, from, to }: GetMovementWardRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<MovementWardDTO>>>;
	getMovementWard(
		{ wardCode, from, to }: GetMovementWardRequest,
		opts?: OperationOpts,
	): Observable<Array<MovementWardDTO> | AjaxResponse<Array<MovementWardDTO>>> {
		...
		return this.request<Array<MovementWardDTO>>(
			{
				url: '/medicalstockward/movements/{ward_code}'.replace(
					'{ward_code}',
					encodeURI(wardCode),
				),
				method: 'GET',
	...
	getWardMovementsToWard({
		...
		from,
		to,
	}: GetWardMovementsToWardRequest): Observable<Array<MovementWardDTO>>;
	getWardMovementsToWard(
		{ targetWardCode, from, to }: GetWardMovementsToWardRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<MovementWardDTO>>>;
	getWardMovementsToWard(
		{ targetWardCode, from, to }: GetWardMovementsToWardRequest,
		...
		return this.request<Array<MovementWardDTO>>(
			{
				url: '/medicalstockward/movements/to/{target_ward_code}'.replace(
					'{target_ward_code}',
					encodeURI(targetWardCode),
				),
				method: 'GET',
				headers,
				query,
	...
	newMovementWard({
		movementWardDTO,
	}: NewMovementWardRequest): Observable<boolean>;
	newMovementWard(
		{ movementWardDTO }: NewMovementWardRequest,
		opts?: OperationOpts,
