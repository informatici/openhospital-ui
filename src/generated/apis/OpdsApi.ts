...
export class OpdsApi extends BaseAPI {
    ...
    deleteOpd({ code }: DeleteOpdRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    deleteOpd({ code }: DeleteOpdRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    getLastOpd({ patientCode }: GetLastOpdRequest, opts?: OperationOpts): Observable<AjaxResponse<OpdDTO>>
    getLastOpd({ patientCode }: GetLastOpdRequest, opts?: OperationOpts): Observable<OpdDTO | AjaxResponse<OpdDTO>> {
    ...
    getOpdByDates({ dateFrom, dateTo, diseaseTypeCode, diseaseCode, ageFrom, ageTo, sex, newPatient, patientCode, page, size, paged, wardCode }: GetOpdByDatesRequest, opts?: OperationOpts): Observable<AjaxResponse<PageOpdDTO>>
    getOpdByDates({ dateFrom, dateTo, diseaseTypeCode, diseaseCode, ageFrom, ageTo, sex, newPatient, patientCode, page, size, paged, wardCode }: GetOpdByDatesRequest, opts?: OperationOpts): Observable<PageOpdDTO | AjaxResponse<PageOpdDTO>> {
    ...
    getOpdByPatient({ pcode }: GetOpdByPatientRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<OpdWithOperationRowDTO>>>
    getOpdByPatient({ pcode }: GetOpdByPatientRequest, opts?: OperationOpts): Observable<Array<OpdWithOperationRowDTO> | AjaxResponse<Array<OpdWithOperationRowDTO>>> {
    ...
    getOpdToDayOrWeek({ oneWeek }: GetOpdToDayOrWeekRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<OpdDTO>>>
    getOpdToDayOrWeek({ oneWeek }: GetOpdToDayOrWeekRequest, opts?: OperationOpts): Observable<Array<OpdDTO> | AjaxResponse<Array<OpdDTO>>> {
    ...
    getProgressiveYear({ year }: GetProgressiveYearRequest, opts?: OperationOpts): Observable<AjaxResponse<number>>
    getProgressiveYear({ year }: GetProgressiveYearRequest, opts?: OperationOpts): Observable<number | AjaxResponse<number>> {
    ...
    isExistOpdNum({ opdNum, year }: IsExistOpdNumRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    isExistOpdNum({ opdNum, year }: IsExistOpdNumRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    newOpd({ opdDTO }: NewOpdRequest, opts?: OperationOpts): Observable<AjaxResponse<OpdDTO>>
    newOpd({ opdDTO }: NewOpdRequest, opts?: OperationOpts): Observable<OpdDTO | AjaxResponse<OpdDTO>> {
    ...
    newOpdWithOperationRow({ opdWithOperationRowDTO }: NewOpdWithOperationRowRequest, opts?: OperationOpts): Observable<AjaxResponse<OpdWithOperationRowDTO>>
    newOpdWithOperationRow({ opdWithOperationRowDTO }: NewOpdWithOperationRowRequest, opts?: OperationOpts): Observable<OpdWithOperationRowDTO | AjaxResponse<OpdWithOperationRowDTO>> {
    ...
    updateOpd({ code, opdDTO }: UpdateOpdRequest, opts?: OperationOpts): Observable<AjaxResponse<OpdDTO>>
    updateOpd({ code, opdDTO }: UpdateOpdRequest, opts?: OperationOpts): Observable<OpdDTO | AjaxResponse<OpdDTO>> {
    ...
    updateOpdWithOperationRow({ code, opdWithOperationRowDTO }: UpdateOpdWithOperationRowRequest, opts?: OperationOpts): Observable<AjaxResponse<OpdWithOperationRowDTO>>
    updateOpdWithOperationRow({ code, opdWithOperationRowDTO }: UpdateOpdWithOperationRowRequest, opts?: OperationOpts): Observable<OpdWithOperationRowDTO | AjaxResponse<OpdWithOperationRowDTO>> {
