...
import type { OpdDTO, OpdWithOperationRowDTO, PageOpdDTO } from '../models';
...
export class OpdsApi extends BaseAPI {
	...
	getLastOpd(
		{ patientCode }: GetLastOpdRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OpdDTO>>;
	getLastOpd(
		{ patientCode }: GetLastOpdRequest,
		opts?: OperationOpts,
	): Observable<OpdDTO | AjaxResponse<OpdDTO>> {
	...
	getOpdByDates({
		...
		paged,
		wardCode,
	}: GetOpdByDatesRequest): Observable<PageOpdDTO>;
	getOpdByDates(
		{
			dateFrom,
			dateTo,
			...
			paged,
			wardCode,
		}: GetOpdByDatesRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PageOpdDTO>>;
	getOpdByDates(
		{
			dateFrom,
			dateTo,
		...
		opts?: OperationOpts,
	): Observable<PageOpdDTO | AjaxResponse<PageOpdDTO>> {
	...
	getOpdByPatient({
		pcode,
	}: GetOpdByPatientRequest): Observable<Array<OpdWithOperationRowDTO>>;
	getOpdByPatient(
		{ pcode }: GetOpdByPatientRequest,
		opts?: OperationOpts,
	...
	getOpdToDayOrWeek({
		oneWeek,
	}: GetOpdToDayOrWeekRequest): Observable<Array<OpdDTO>>;
	getOpdToDayOrWeek(
		{ oneWeek }: GetOpdToDayOrWeekRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<OpdDTO>>>;
	getOpdToDayOrWeek(
		{ oneWeek }: GetOpdToDayOrWeekRequest,
		opts?: OperationOpts,
	): Observable<Array<OpdDTO> | AjaxResponse<Array<OpdDTO>>> {
		const headers: HttpHeaders = {};
	...
	getProgressiveYear(
		{ year }: GetProgressiveYearRequest,
		opts?: OperationOpts,
	...
	isExistOpdNum(
		{ opdNum, year }: IsExistOpdNumRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	isExistOpdNum(
		{ opdNum, year }: IsExistOpdNumRequest,
	...
	}: NewOpdWithOperationRowRequest): Observable<OpdWithOperationRowDTO>;
	newOpdWithOperationRow(
		{ opdWithOperationRowDTO }: NewOpdWithOperationRowRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OpdWithOperationRowDTO>>;
	newOpdWithOperationRow(
		{ opdWithOperationRowDTO }: NewOpdWithOperationRowRequest,
		opts?: OperationOpts,
	): Observable<OpdWithOperationRowDTO | AjaxResponse<OpdWithOperationRowDTO>> {
	...
	updateOpdWithOperationRow({
		code,
		opdWithOperationRowDTO,
	}: UpdateOpdWithOperationRowRequest): Observable<OpdWithOperationRowDTO>;
	updateOpdWithOperationRow(
		{ code, opdWithOperationRowDTO }: UpdateOpdWithOperationRowRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OpdWithOperationRowDTO>>;
	updateOpdWithOperationRow(
		{ code, opdWithOperationRowDTO }: UpdateOpdWithOperationRowRequest,
