...
export class UserGroupsApi extends BaseAPI {
	...
	assignPermission({
		groupCode,
		id,
	}: AssignPermissionRequest): Observable<number>;
	assignPermission(
		{ groupCode, id }: AssignPermissionRequest,
		opts?: OperationOpts,
	...
	assignPermission(
		...
		return this.request<number>(
			{
				url: '/usergroups/{group_code}/permissions/{id}'
					.replace('{group_code}', encodeURI(groupCode))
	...
	deleteGroup(
		...
		return this.request<void>(
			{
				url: '/usergroups/{group_code}'.replace(
					'{group_code}',
					encodeURI(groupCode),
				),
				method: 'DELETE',
	...
	getUserGroup(
		{ groupCode }: GetUserGroupRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<UserGroupDTO>>;
	getUserGroup(
		{ groupCode }: GetUserGroupRequest,
		opts?: OperationOpts,
	): Observable<UserGroupDTO | AjaxResponse<UserGroupDTO>> {
	...
	getUserGroups(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<UserGroupDTO>>>;
	getUserGroups(
		opts?: OperationOpts,
	): Observable<Array<UserGroupDTO> | AjaxResponse<Array<UserGroupDTO>>> {
		const headers: HttpHeaders = {};
	...
	newUserGroup(
		{ userGroupDTO }: NewUserGroupRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<UserGroupDTO>>;
	newUserGroup(
		{ userGroupDTO }: NewUserGroupRequest,
	...
	replaceGroupPermissions({
		groupCode,
		groupPermissionsDTO,
	}: ReplaceGroupPermissionsRequest): Observable<Array<PermissionDTO>>;
	replaceGroupPermissions(
		{ groupCode, groupPermissionsDTO }: ReplaceGroupPermissionsRequest,
		opts?: OperationOpts,
	...
	replaceGroupPermissions(
		...
		return this.request<Array<PermissionDTO>>(
			{
				url: '/usergroups/{group_code}/permissions'.replace(
					'{group_code}',
					encodeURI(groupCode),
				),
				method: 'PATCH',
	...
	revokePermission({
		groupCode,
		id,
	}: RevokePermissionRequest): Observable<void>;
	revokePermission(
		{ groupCode, id }: RevokePermissionRequest,
		opts?: OperationOpts,
	): Observable<void | AjaxResponse<void>>;
	revokePermission(
		{ groupCode, id }: RevokePermissionRequest,
	...
	updateGroupPermissions({
		groupCode,
		groupPermissionsDTO,
	}: UpdateGroupPermissionsRequest): Observable<Array<PermissionDTO>>;
	updateGroupPermissions(
		{ groupCode, groupPermissionsDTO }: UpdateGroupPermissionsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<PermissionDTO>>>;
	updateGroupPermissions(
		{ groupCode, groupPermissionsDTO }: UpdateGroupPermissionsRequest,
	...
	updateUserGroup({
		groupCode,
		userGroupDTO,
	}: UpdateUserGroupRequest): Observable<UserGroupDTO>;
	updateUserGroup(
		{ groupCode, userGroupDTO }: UpdateUserGroupRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<UserGroupDTO>>;
	updateUserGroup(
		{ groupCode, userGroupDTO }: UpdateUserGroupRequest,
