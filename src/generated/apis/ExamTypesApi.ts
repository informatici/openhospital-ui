...
import type { ExamTypeDTO } from '../models';
...
export class ExamTypesApi extends BaseAPI {
	...
	getExamTypes(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<ExamTypeDTO>>>;
	getExamTypes(
		opts?: OperationOpts,
	): Observable<Array<ExamTypeDTO> | AjaxResponse<Array<ExamTypeDTO>>> {
		const headers: HttpHeaders = {};
	...
	newExamType(
		{ examTypeDTO }: NewExamTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<ExamTypeDTO>>;
	newExamType(
		{ examTypeDTO }: NewExamTypeRequest,
		opts?: OperationOpts,
	): Observable<ExamTypeDTO | AjaxResponse<ExamTypeDTO>> {
	...
	updateExamType({
		code,
		examTypeDTO,
	}: UpdateExamTypeRequest): Observable<ExamTypeDTO>;
	updateExamType(
		{ code, examTypeDTO }: UpdateExamTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<ExamTypeDTO>>;
	updateExamType(
		{ code, examTypeDTO }: UpdateExamTypeRequest,
