...
import type { SmsDTO } from '../models';
...
export class SMSApi extends BaseAPI {
	...
	getAll(
		{ dateFrom, dateTo }: GetAllRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<SmsDTO>>>;
	getAll(
		{ dateFrom, dateTo }: GetAllRequest,
		opts?: OperationOpts,
	): Observable<Array<SmsDTO> | AjaxResponse<Array<SmsDTO>>> {
