...
import { PagePatientExaminationDTO, PatientExaminationDTO } from "../models";
...
export class ExaminationControllerApi extends BaseAPI {
  ...
  getLastNByPatIDUsingGET({
    limit,
    patId,
  }: GetLastNByPatIDUsingGETRequest): Observable<PagePatientExaminationDTO>;
  getLastNByPatIDUsingGET(
    { limit, patId }: GetLastNByPatIDUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<PagePatientExaminationDTO>>;
  getLastNByPatIDUsingGET(
    { limit, patId }: GetLastNByPatIDUsingGETRequest,
    opts?: OperationOpts
  ): Observable<
    PagePatientExaminationDTO | RawAjaxResponse<PagePatientExaminationDTO>
  > {
  ...
  updateExaminationUsingPUT({
    id,
    dto,
  }: UpdateExaminationUsingPUTRequest): Observable<boolean>;
  updateExaminationUsingPUT(
