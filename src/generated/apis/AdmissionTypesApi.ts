...
import type { AdmissionTypeDTO } from '../models';
...
export class AdmissionTypesApi extends BaseAPI {
	...
	deleteAdmissionType({
		code,
	}: DeleteAdmissionTypeRequest): Observable<boolean>;
	deleteAdmissionType(
		{ code }: DeleteAdmissionTypeRequest,
		opts?: OperationOpts,
	...
	getAdmissionTypes(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<AdmissionTypeDTO>>>;
	getAdmissionTypes(
		opts?: OperationOpts,
	): Observable<
		Array<AdmissionTypeDTO> | AjaxResponse<Array<AdmissionTypeDTO>>
	> {
		const headers: HttpHeaders = {};
	...
	newAdmissionType({
		admissionTypeDTO,
	}: NewAdmissionTypeRequest): Observable<AdmissionTypeDTO>;
	newAdmissionType(
		{ admissionTypeDTO }: NewAdmissionTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<AdmissionTypeDTO>>;
	newAdmissionType(
		{ admissionTypeDTO }: NewAdmissionTypeRequest,
		opts?: OperationOpts,
	): Observable<AdmissionTypeDTO | AjaxResponse<AdmissionTypeDTO>> {
	...
	updateAdmissionTypes({
		admissionTypeDTO,
	}: UpdateAdmissionTypesRequest): Observable<AdmissionTypeDTO>;
	updateAdmissionTypes(
		{ admissionTypeDTO }: UpdateAdmissionTypesRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<AdmissionTypeDTO>>;
	updateAdmissionTypes(
		{ admissionTypeDTO }: UpdateAdmissionTypesRequest,
