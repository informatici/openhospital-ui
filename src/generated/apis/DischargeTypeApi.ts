...
import type { DischargeTypeDTO } from '../models';
...
export class DischargeTypeApi extends BaseAPI {
	...
	deleteDischargeType({
		code,
	}: DeleteDischargeTypeRequest): Observable<boolean>;
	deleteDischargeType(
		{ code }: DeleteDischargeTypeRequest,
		opts?: OperationOpts,
	...
	getDischargeTypes(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DischargeTypeDTO>>>;
	getDischargeTypes(
		opts?: OperationOpts,
	): Observable<
		Array<DischargeTypeDTO> | AjaxResponse<Array<DischargeTypeDTO>>
	> {
		const headers: HttpHeaders = {};
	...
	newDischargeType({
		dischargeTypeDTO,
	}: NewDischargeTypeRequest): Observable<DischargeTypeDTO>;
	newDischargeType(
		{ dischargeTypeDTO }: NewDischargeTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DischargeTypeDTO>>;
	newDischargeType(
		{ dischargeTypeDTO }: NewDischargeTypeRequest,
		opts?: OperationOpts,
	): Observable<DischargeTypeDTO | AjaxResponse<DischargeTypeDTO>> {
	...
	updateDischargeType({
		dischargeTypeDTO,
	}: UpdateDischargeTypeRequest): Observable<DischargeTypeDTO>;
	updateDischargeType(
		{ dischargeTypeDTO }: UpdateDischargeTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DischargeTypeDTO>>;
	updateDischargeType(
		{ dischargeTypeDTO }: UpdateDischargeTypeRequest,
