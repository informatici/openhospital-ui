...
import type { DeliveryResultTypeDTO } from '../models';
...
export class DeliveryResultTypeApi extends BaseAPI {
	...
	deleteDeliveryResultType({
		code,
	}: DeleteDeliveryResultTypeRequest): Observable<boolean>;
	deleteDeliveryResultType(
		{ code }: DeleteDeliveryResultTypeRequest,
		opts?: OperationOpts,
	...
	getDeliveryResultTypes(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DeliveryResultTypeDTO>>>;
	getDeliveryResultTypes(
		opts?: OperationOpts,
	): Observable<
		Array<DeliveryResultTypeDTO> | AjaxResponse<Array<DeliveryResultTypeDTO>>
	> {
		const headers: HttpHeaders = {};
	...
	}: NewDeliveryResultTypeRequest): Observable<DeliveryResultTypeDTO>;
	newDeliveryResultType(
		{ deliveryResultTypeDTO }: NewDeliveryResultTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DeliveryResultTypeDTO>>;
	newDeliveryResultType(
		{ deliveryResultTypeDTO }: NewDeliveryResultTypeRequest,
		opts?: OperationOpts,
	): Observable<DeliveryResultTypeDTO | AjaxResponse<DeliveryResultTypeDTO>> {
	...
	updateDeliveryResultTypes({
		deliveryResultTypeDTO,
	}: UpdateDeliveryResultTypesRequest): Observable<DeliveryResultTypeDTO>;
	updateDeliveryResultTypes(
		{ deliveryResultTypeDTO }: UpdateDeliveryResultTypesRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DeliveryResultTypeDTO>>;
	updateDeliveryResultTypes(
		{ deliveryResultTypeDTO }: UpdateDeliveryResultTypesRequest,
