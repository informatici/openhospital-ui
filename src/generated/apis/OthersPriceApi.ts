...
import type { PricesOthersDTO } from '../models';
...
export class OthersPriceApi extends BaseAPI {
	...
	getPricesOthers(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<PricesOthersDTO>>>;
	getPricesOthers(
		opts?: OperationOpts,
	): Observable<Array<PricesOthersDTO> | AjaxResponse<Array<PricesOthersDTO>>> {
		const headers: HttpHeaders = {};
	...
	newPricesOthers({
		pricesOthersDTO,
	}: NewPricesOthersRequest): Observable<PricesOthersDTO>;
	newPricesOthers(
		{ pricesOthersDTO }: NewPricesOthersRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PricesOthersDTO>>;
	newPricesOthers(
		{ pricesOthersDTO }: NewPricesOthersRequest,
		opts?: OperationOpts,
	): Observable<PricesOthersDTO | AjaxResponse<PricesOthersDTO>> {
	...
	updatePricesOthers({
		id,
		pricesOthersDTO,
	}: UpdatePricesOthersRequest): Observable<PricesOthersDTO>;
	updatePricesOthers(
		{ id, pricesOthersDTO }: UpdatePricesOthersRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PricesOthersDTO>>;
	updatePricesOthers(
		{ id, pricesOthersDTO }: UpdatePricesOthersRequest,
