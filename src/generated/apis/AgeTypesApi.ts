...
import type { AgeTypeDTO } from '../models';
...
export class AgeTypesApi extends BaseAPI {
	...
	getAgeTypeByIndex({
		index,
	}: GetAgeTypeByIndexRequest): Observable<AgeTypeDTO>;
	getAgeTypeByIndex(
		{ index }: GetAgeTypeByIndexRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<AgeTypeDTO>>;
	getAgeTypeByIndex(
		{ index }: GetAgeTypeByIndexRequest,
		opts?: OperationOpts,
	): Observable<AgeTypeDTO | AjaxResponse<AgeTypeDTO>> {
	...
	getAgeTypeCodeByAge({
		age,
	}: GetAgeTypeCodeByAgeRequest): Observable<{ [key: string]: string }>;
	getAgeTypeCodeByAge(
		{ age }: GetAgeTypeCodeByAgeRequest,
		opts?: OperationOpts,
	...
	getAllAgeTypes(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<AgeTypeDTO>>>;
	getAllAgeTypes(
		opts?: OperationOpts,
	): Observable<Array<AgeTypeDTO> | AjaxResponse<Array<AgeTypeDTO>>> {
		const headers: HttpHeaders = {};
	...
	updateAgeType({
		ageTypeDTO,
	}: UpdateAgeTypeRequest): Observable<Array<AgeTypeDTO>>;
	updateAgeType(
		{ ageTypeDTO }: UpdateAgeTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<AgeTypeDTO>>>;
	updateAgeType(
		{ ageTypeDTO }: UpdateAgeTypeRequest,
