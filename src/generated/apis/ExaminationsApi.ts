...
export class ExaminationsApi extends BaseAPI {
	...
	getByID(
		{ id }: GetByIDRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PatientExaminationDTO>>;
	getByID(
		{ id }: GetByIDRequest,
		opts?: OperationOpts,
	): Observable<PatientExaminationDTO | AjaxResponse<PatientExaminationDTO>> {
	...
	getByPatientId({
		patId,
	}: GetByPatientIdRequest): Observable<Array<PatientExaminationDTO>>;
	getByPatientId(
		{ patId }: GetByPatientIdRequest,
		opts?: OperationOpts,
	...
	getDefaultPatientExamination({
		patId,
	}: GetDefaultPatientExaminationRequest): Observable<PatientExaminationDTO>;
	getDefaultPatientExamination(
		{ patId }: GetDefaultPatientExaminationRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PatientExaminationDTO>>;
	getDefaultPatientExamination(
		{ patId }: GetDefaultPatientExaminationRequest,
	...
	getFromLastPatientExamination({
		id,
	}: GetFromLastPatientExaminationRequest): Observable<PatientExaminationDTO>;
	getFromLastPatientExamination(
		{ id }: GetFromLastPatientExaminationRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PatientExaminationDTO>>;
	getFromLastPatientExamination(
		{ id }: GetFromLastPatientExaminationRequest,
	...
	getLastByPatientId({
		patId,
	}: GetLastByPatientIdRequest): Observable<PatientExaminationDTO>;
	getLastByPatientId(
		{ patId }: GetLastByPatientIdRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PatientExaminationDTO>>;
	getLastByPatientId(
		{ patId }: GetLastByPatientIdRequest,
	...
	getLastNByPatID({
		limit,
		patId,
	}: GetLastNByPatIDRequest): Observable<PagePatientExaminationDTO>;
	getLastNByPatID(
		{ limit, patId }: GetLastNByPatIDRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PagePatientExaminationDTO>>;
	getLastNByPatID(
		{ limit, patId }: GetLastNByPatIDRequest,
		opts?: OperationOpts,
	): Observable<
		PagePatientExaminationDTO | AjaxResponse<PagePatientExaminationDTO>
	> {
	...
	newPatientExamination({
		patientExaminationDTO,
	}: NewPatientExaminationRequest): Observable<PatientExaminationDTO>;
	newPatientExamination(
		{ patientExaminationDTO }: NewPatientExaminationRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PatientExaminationDTO>>;
	newPatientExamination(
		{ patientExaminationDTO }: NewPatientExaminationRequest,
	...
	updateExamination({
		id,
		patientExaminationDTO,
	}: UpdateExaminationRequest): Observable<PatientExaminationDTO>;
	updateExamination(
		{ id, patientExaminationDTO }: UpdateExaminationRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<PatientExaminationDTO>>;
	updateExamination(
		{ id, patientExaminationDTO }: UpdateExaminationRequest,
