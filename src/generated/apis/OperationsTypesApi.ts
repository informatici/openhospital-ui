...
import type { OperationTypeDTO } from '../models';
...
export class OperationsTypesApi extends BaseAPI {
	...
	deleteOperationType({
		code,
	}: DeleteOperationTypeRequest): Observable<boolean>;
	deleteOperationType(
		{ code }: DeleteOperationTypeRequest,
		opts?: OperationOpts,
	...
	getOperationTypes(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<OperationTypeDTO>>>;
	getOperationTypes(
		opts?: OperationOpts,
	): Observable<
		Array<OperationTypeDTO> | AjaxResponse<Array<OperationTypeDTO>>
	> {
		const headers: HttpHeaders = {};
	...
	newOperationType({
		operationTypeDTO,
	}: NewOperationTypeRequest): Observable<OperationTypeDTO>;
	newOperationType(
		{ operationTypeDTO }: NewOperationTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OperationTypeDTO>>;
	newOperationType(
		{ operationTypeDTO }: NewOperationTypeRequest,
		opts?: OperationOpts,
	): Observable<OperationTypeDTO | AjaxResponse<OperationTypeDTO>> {
	...
	updateOperationTypes({
		code,
		operationTypeDTO,
	}: UpdateOperationTypesRequest): Observable<OperationTypeDTO>;
	updateOperationTypes(
		{ code, operationTypeDTO }: UpdateOperationTypesRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<OperationTypeDTO>>;
	updateOperationTypes(
		{ code, operationTypeDTO }: UpdateOperationTypesRequest,
