...
import { PagePatientDTO, PatientDTO } from "../models";
...
export class PatientControllerApi extends BaseAPI {
  ...
  deletePatientUsingDELETE({
    code,
  }: DeletePatientUsingDELETERequest): Observable<boolean>;
  deletePatientUsingDELETE(
    { code }: DeletePatientUsingDELETERequest,
    opts?: OperationOpts
   ...
   * getPatientAll
   */
  getPatientAllUsingGET({
    code,
  }: GetPatientAllUsingGETRequest): Observable<PatientDTO>;
  getPatientAllUsingGET(
    { code }: GetPatientAllUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<PatientDTO>>;
  getPatientAllUsingGET(
    { code }: GetPatientAllUsingGETRequest,
    opts?: OperationOpts
  ): Observable<PatientDTO | RawAjaxResponse<PatientDTO>> {
  ...
  getPatientUsingGET({
    code,
  }: GetPatientUsingGETRequest): Observable<PatientDTO>;
  getPatientUsingGET(
    { code }: GetPatientUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<PatientDTO>>;
  getPatientUsingGET(
    { code }: GetPatientUsingGETRequest,
  ...
  getPatientsUsingGET({
    page,
    size,
  }: GetPatientsUsingGETRequest): Observable<PagePatientDTO>;
  getPatientsUsingGET(
    { page, size }: GetPatientsUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<PagePatientDTO>>;
  getPatientsUsingGET(
    { page, size }: GetPatientsUsingGETRequest,
    opts?: OperationOpts
  ): Observable<PagePatientDTO | RawAjaxResponse<PagePatientDTO>> {
    const headers: HttpHeaders = {
      ...(this.configuration.apiKey && {
        Authorization: this.configuration.apiKey("Authorization"),
      }), // JWT authentication
   ...
   * mergePatients
   */
  mergePatientsUsingGET({
    code2,
    mergedcode,
  }: MergePatientsUsingGETRequest): Observable<boolean>;
  mergePatientsUsingGET(
    { code2, mergedcode }: MergePatientsUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<boolean>>;
  mergePatientsUsingGET(
    { code2, mergedcode }: MergePatientsUsingGETRequest,
  ...
  newPatientUsingPOST({
    newPatient,
  }: NewPatientUsingPOSTRequest): Observable<PatientDTO>;
  newPatientUsingPOST(
    { newPatient }: NewPatientUsingPOSTRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<PatientDTO>>;
  newPatientUsingPOST(
    { newPatient }: NewPatientUsingPOSTRequest,
  ...
  searchPatientUsingGET({
    ...
    firstName,
    secondName,
  }: SearchPatientUsingGETRequest): Observable<Array<PatientDTO>>;
  searchPatientUsingGET(
    { address, birthDate, firstName, secondName }: SearchPatientUsingGETRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<Array<PatientDTO>>>;
  searchPatientUsingGET(
    { address, birthDate, firstName, secondName }: SearchPatientUsingGETRequest,
    opts?: OperationOpts
  ): Observable<Array<PatientDTO> | RawAjaxResponse<Array<PatientDTO>>> {
    const headers: HttpHeaders = {
      ...(this.configuration.apiKey && {
        Authorization: this.configuration.apiKey("Authorization"),
      }), // JWT authentication
  ...
  updatePatientUsingPUT({
    code,
    updatePatient,
  }: UpdatePatientUsingPUTRequest): Observable<PatientDTO>;
  updatePatientUsingPUT(
    { code, updatePatient }: UpdatePatientUsingPUTRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<PatientDTO>>;
  updatePatientUsingPUT(
    { code, updatePatient }: UpdatePatientUsingPUTRequest,
