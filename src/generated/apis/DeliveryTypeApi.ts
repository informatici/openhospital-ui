...
import type { DeliveryTypeDTO } from '../models';
...
export class DeliveryTypeApi extends BaseAPI {
	...
	deleteDeliveryType(
		{ code }: DeleteDeliveryTypeRequest,
		opts?: OperationOpts,
	...
	getDeliveryTypes(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DeliveryTypeDTO>>>;
	getDeliveryTypes(
		opts?: OperationOpts,
	): Observable<Array<DeliveryTypeDTO> | AjaxResponse<Array<DeliveryTypeDTO>>> {
		const headers: HttpHeaders = {};
	...
	newDeliveryType({
		deliveryTypeDTO,
	}: NewDeliveryTypeRequest): Observable<DeliveryTypeDTO>;
	newDeliveryType(
		{ deliveryTypeDTO }: NewDeliveryTypeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DeliveryTypeDTO>>;
	newDeliveryType(
		{ deliveryTypeDTO }: NewDeliveryTypeRequest,
		opts?: OperationOpts,
	): Observable<DeliveryTypeDTO | AjaxResponse<DeliveryTypeDTO>> {
	...
	updateDeliveryTypes({
		deliveryTypeDTO,
	}: UpdateDeliveryTypesRequest): Observable<DeliveryTypeDTO>;
	updateDeliveryTypes(
		{ deliveryTypeDTO }: UpdateDeliveryTypesRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DeliveryTypeDTO>>;
	updateDeliveryTypes(
		{ deliveryTypeDTO }: UpdateDeliveryTypesRequest,
