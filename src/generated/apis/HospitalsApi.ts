...
import type { HospitalDTO } from '../models';
...
export class HospitalsApi extends BaseAPI {
	...
	getHospital(
		opts?: OperationOpts,
	): Observable<HospitalDTO | AjaxResponse<HospitalDTO>> {
	...
	updateHospital({
		code,
		hospitalDTO,
	}: UpdateHospitalRequest): Observable<HospitalDTO>;
	updateHospital(
		{ code, hospitalDTO }: UpdateHospitalRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<HospitalDTO>>;
	updateHospital(
		{ code, hospitalDTO }: UpdateHospitalRequest,
		opts?: OperationOpts,
	): Observable<HospitalDTO | AjaxResponse<HospitalDTO>> {
