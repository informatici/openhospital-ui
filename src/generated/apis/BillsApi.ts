...
export class BillsApi extends BaseAPI {
	...
	getBill(
		{ id }: GetBillRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<BillDTO>>;
	getBill(
		{ id }: GetBillRequest,
		opts?: OperationOpts,
	): Observable<BillDTO | AjaxResponse<BillDTO>> {
	...
	getDistinctItems(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<BillItemsDTO>>>;
	getDistinctItems(
		opts?: OperationOpts,
	): Observable<Array<BillItemsDTO> | AjaxResponse<Array<BillItemsDTO>>> {
		const headers: HttpHeaders = {};
	...
	getPaymentsByBillId({
		billId,
	}: GetPaymentsByBillIdRequest): Observable<Array<BillPaymentsDTO>>;
	getPaymentsByBillId(
		{ billId }: GetPaymentsByBillIdRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<BillPaymentsDTO>>>;
	getPaymentsByBillId(
		{ billId }: GetPaymentsByBillIdRequest,
		opts?: OperationOpts,
	): Observable<Array<BillPaymentsDTO> | AjaxResponse<Array<BillPaymentsDTO>>> {
	...
	getPendingBills({
		patientCode,
	}: GetPendingBillsRequest): Observable<Array<BillDTO>>;
	getPendingBills(
		{ patientCode }: GetPendingBillsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<BillDTO>>>;
	getPendingBills(
		{ patientCode }: GetPendingBillsRequest,
		opts?: OperationOpts,
	): Observable<Array<BillDTO> | AjaxResponse<Array<BillDTO>>> {
	...
	getPendingBillsAffiliate({
		patientCode,
	}: GetPendingBillsAffiliateRequest): Observable<Array<BillDTO>>;
	getPendingBillsAffiliate(
		{ patientCode }: GetPendingBillsAffiliateRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<BillDTO>>>;
	getPendingBillsAffiliate(
		{ patientCode }: GetPendingBillsAffiliateRequest,
	...
	newBill(
		{ fullBillDTO }: NewBillRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<FullBillDTO>>;
	newBill(
		{ fullBillDTO }: NewBillRequest,
		opts?: OperationOpts,
	): Observable<FullBillDTO | AjaxResponse<FullBillDTO>> {
	...
	searchBills({
		...
		dateto,
		patientCode,
	}: SearchBillsRequest): Observable<Array<BillDTO>>;
	searchBills(
		{ datefrom, dateto, patientCode }: SearchBillsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<BillDTO>>>;
	searchBills(
		{ datefrom, dateto, patientCode }: SearchBillsRequest,
	...
	searchBills1({
		...
		dateto,
		billItemsDTO,
	}: SearchBills1Request): Observable<Array<BillDTO>>;
	searchBills1(
		{ datefrom, dateto, billItemsDTO }: SearchBills1Request,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<BillDTO>>>;
	searchBills1(
		{ datefrom, dateto, billItemsDTO }: SearchBills1Request,
	...
	searchBillsByPayments({
		billPaymentsDTO,
	}: SearchBillsByPaymentsRequest): Observable<Array<BillDTO>>;
	searchBillsByPayments(
		{ billPaymentsDTO }: SearchBillsByPaymentsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<BillDTO>>>;
	searchBillsByPayments(
		{ billPaymentsDTO }: SearchBillsByPaymentsRequest,
	...
	searchBillsPayments({
		...
		dateto,
		patientCode,
	}: SearchBillsPaymentsRequest): Observable<Array<BillPaymentsDTO>>;
	searchBillsPayments(
		{ datefrom, dateto, patientCode }: SearchBillsPaymentsRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<BillPaymentsDTO>>>;
	searchBillsPayments(
		{ datefrom, dateto, patientCode }: SearchBillsPaymentsRequest,
	...
	updateBill(
		{ id, fullBillDTO }: UpdateBillRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<FullBillDTO>>;
	updateBill(
		{ id, fullBillDTO }: UpdateBillRequest,
