...
import type { MedicalDTO } from '../models';
...
export class MedicalsApi extends BaseAPI {
	...
	filterMedicals({
		...
		critical,
		nameSorted,
	}: FilterMedicalsRequest): Observable<Array<MedicalDTO>>;
	filterMedicals(
		{ desc, type, critical, nameSorted }: FilterMedicalsRequest,
		opts?: OperationOpts,
	...
	getMedical(
		{ code }: GetMedicalRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<MedicalDTO>>;
	getMedical(
		{ code }: GetMedicalRequest,
		opts?: OperationOpts,
	): Observable<MedicalDTO | AjaxResponse<MedicalDTO>> {
	...
	newMedical({
		medicalDTO,
		ignoreSimilar,
	}: NewMedicalRequest): Observable<MedicalDTO>;
	newMedical(
		{ medicalDTO, ignoreSimilar }: NewMedicalRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<MedicalDTO>>;
	newMedical(
		{ medicalDTO, ignoreSimilar }: NewMedicalRequest,
	...
	updateMedical({
		medicalDTO,
		ignoreSimilar,
	}: UpdateMedicalRequest): Observable<MedicalDTO>;
	updateMedical(
		{ medicalDTO, ignoreSimilar }: UpdateMedicalRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<MedicalDTO>>;
	updateMedical(
		{ medicalDTO, ignoreSimilar }: UpdateMedicalRequest,
