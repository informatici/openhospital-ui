...
export class PatientVaccinesApi extends BaseAPI {
    ...
    deletePatientVaccine({ code }: DeletePatientVaccineRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    deletePatientVaccine({ code }: DeletePatientVaccineRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    getPatientVaccines({ oneWeek }: GetPatientVaccinesRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<PatientVaccineDTO>>>
    getPatientVaccines({ oneWeek }: GetPatientVaccinesRequest, opts?: OperationOpts): Observable<Array<PatientVaccineDTO> | AjaxResponse<Array<PatientVaccineDTO>>> {
    ...
    getPatientVaccinesByDatesRanges({ vaccineTypeCode, vaccineCode, dateFrom, dateTo, sex, ageFrom, ageTo }: GetPatientVaccinesByDatesRangesRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<PatientVaccineDTO>>>
    getPatientVaccinesByDatesRanges({ vaccineTypeCode, vaccineCode, dateFrom, dateTo, sex, ageFrom, ageTo }: GetPatientVaccinesByDatesRangesRequest, opts?: OperationOpts): Observable<Array<PatientVaccineDTO> | AjaxResponse<Array<PatientVaccineDTO>>> {
    ...
    getProgYear({ year }: GetProgYearRequest, opts?: OperationOpts): Observable<AjaxResponse<number>>
    getProgYear({ year }: GetProgYearRequest, opts?: OperationOpts): Observable<number | AjaxResponse<number>> {
    ...
    newPatientVaccine({ patientVaccineDTO }: NewPatientVaccineRequest, opts?: OperationOpts): Observable<AjaxResponse<PatientVaccineDTO>>
    newPatientVaccine({ patientVaccineDTO }: NewPatientVaccineRequest, opts?: OperationOpts): Observable<PatientVaccineDTO | AjaxResponse<PatientVaccineDTO>> {
    ...
    updatePatientVaccinet({ code, patientVaccineDTO }: UpdatePatientVaccinetRequest, opts?: OperationOpts): Observable<AjaxResponse<PatientVaccineDTO>>
    updatePatientVaccinet({ code, patientVaccineDTO }: UpdatePatientVaccinetRequest, opts?: OperationOpts): Observable<PatientVaccineDTO | AjaxResponse<PatientVaccineDTO>> {
