...
import type { PermissionDTO, UserDTO, UserProfileDTO } from '../models';
...
export class UsersApi extends BaseAPI {
	...
	getUser(
		...
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<UserDTO>>>;
	getUser(
		{ groupId }: GetUserRequest,
		opts?: OperationOpts,
	): Observable<Array<UserDTO> | AjaxResponse<Array<UserDTO>>> {
		const headers: HttpHeaders = {};
	...
	getUserByName(
		{ username }: GetUserByNameRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<UserDTO>>;
	getUserByName(
		{ username }: GetUserByNameRequest,
		opts?: OperationOpts,
	): Observable<UserDTO | AjaxResponse<UserDTO>> {
	...
	retrievePermissionsByUsername({
		username,
	}: RetrievePermissionsByUsernameRequest): Observable<Array<PermissionDTO>>;
	retrievePermissionsByUsername(
		{ username }: RetrievePermissionsByUsernameRequest,
		opts?: OperationOpts,
	...
	retrievePermissionsByUsername(
		...
		return this.request<Array<PermissionDTO>>(
			{
				url: '/users/{username}/permissions'.replace(
					'{username}',
					encodeURI(username),
				),
				method: 'GET',
	...
	retrieveProfileByCurrentLoggedInUser(
		opts?: OperationOpts,
	): Observable<AjaxResponse<UserProfileDTO>>;
	retrieveProfileByCurrentLoggedInUser(
		opts?: OperationOpts,
	): Observable<UserProfileDTO | AjaxResponse<UserProfileDTO>> {
		const headers: HttpHeaders = {};
	...
	updateUser(
		{ username, userDTO }: UpdateUserRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<UserDTO>>;
	updateUser(
		{ username, userDTO }: UpdateUserRequest,
