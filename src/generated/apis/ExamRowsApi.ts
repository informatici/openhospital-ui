...
import type { ExamRowDTO } from '../models';
...
export class ExamRowsApi extends BaseAPI {
	...
	getExamRows(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<ExamRowDTO>>>;
	getExamRows(
		opts?: OperationOpts,
	): Observable<Array<ExamRowDTO> | AjaxResponse<Array<ExamRowDTO>>> {
		const headers: HttpHeaders = {};
	...
	getExamRowsByCode({
		code,
	}: GetExamRowsByCodeRequest): Observable<Array<ExamRowDTO>>;
	getExamRowsByCode(
		{ code }: GetExamRowsByCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<ExamRowDTO>>>;
	getExamRowsByCode(
		{ code }: GetExamRowsByCodeRequest,
	...
	getExamRowsByCodeAndDescription({
		code,
		description,
	}: GetExamRowsByCodeAndDescriptionRequest): Observable<Array<ExamRowDTO>>;
	getExamRowsByCodeAndDescription(
		{ code, description }: GetExamRowsByCodeAndDescriptionRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<ExamRowDTO>>>;
	getExamRowsByCodeAndDescription(
		{ code, description }: GetExamRowsByCodeAndDescriptionRequest,
	...
	getExamRowsByExamCode({
		examCode,
	}: GetExamRowsByExamCodeRequest): Observable<Array<ExamRowDTO>>;
	getExamRowsByExamCode(
		{ examCode }: GetExamRowsByExamCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<ExamRowDTO>>>;
	getExamRowsByExamCode(
		{ examCode }: GetExamRowsByExamCodeRequest,
		...
		return this.request<Array<ExamRowDTO>>(
			{
				url: '/examrows/byExamCode/{examCode}'.replace(
					'{examCode}',
					encodeURI(examCode),
				),
				method: 'GET',
	...
	newExamRow(
		{ examRowDTO }: NewExamRowRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<ExamRowDTO>>;
	newExamRow(
		{ examRowDTO }: NewExamRowRequest,
		opts?: OperationOpts,
	): Observable<ExamRowDTO | AjaxResponse<ExamRowDTO>> {
