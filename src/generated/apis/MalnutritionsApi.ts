...
import type { MalnutritionDTO } from '../models';
...
export class MalnutritionsApi extends BaseAPI {
	...
	deleteMalnutrition(
		{ code }: DeleteMalnutritionRequest,
		opts?: OperationOpts,
	...
	getLastMalnutrition({
		idPatient,
	}: GetLastMalnutritionRequest): Observable<MalnutritionDTO>;
	getLastMalnutrition(
		{ idPatient }: GetLastMalnutritionRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<MalnutritionDTO>>;
	getLastMalnutrition(
		{ idPatient }: GetLastMalnutritionRequest,
		opts?: OperationOpts,
	): Observable<MalnutritionDTO | AjaxResponse<MalnutritionDTO>> {
		...
		return this.request<MalnutritionDTO>(
			{
				url: '/malnutritions/last/{id_patient}'.replace(
					'{id_patient}',
					encodeURI(idPatient),
				),
				method: 'GET',
	...
	getMalnutrition({
		idAdmission,
	}: GetMalnutritionRequest): Observable<Array<MalnutritionDTO>>;
	getMalnutrition(
		{ idAdmission }: GetMalnutritionRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<MalnutritionDTO>>>;
	getMalnutrition(
		{ idAdmission }: GetMalnutritionRequest,
		opts?: OperationOpts,
	): Observable<Array<MalnutritionDTO> | AjaxResponse<Array<MalnutritionDTO>>> {
		...
		return this.request<Array<MalnutritionDTO>>(
			{
				url: '/malnutritions/{id_admission}'.replace(
					'{id_admission}',
					encodeURI(idAdmission),
				),
				method: 'GET',
				headers,
			},
	...
	newMalnutrition({
		malnutritionDTO,
	}: NewMalnutritionRequest): Observable<MalnutritionDTO>;
	newMalnutrition(
		{ malnutritionDTO }: NewMalnutritionRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<MalnutritionDTO>>;
	newMalnutrition(
		{ malnutritionDTO }: NewMalnutritionRequest,
	...
	updateMalnutrition({
		malnutritionDTO,
	}: UpdateMalnutritionRequest): Observable<MalnutritionDTO>;
	updateMalnutrition(
		{ malnutritionDTO }: UpdateMalnutritionRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<MalnutritionDTO>>;
	updateMalnutrition(
		{ malnutritionDTO }: UpdateMalnutritionRequest,
