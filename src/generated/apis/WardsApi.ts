...
import type { WardDTO } from '../models';
...
export class WardsApi extends BaseAPI {
	...
	checkWardMaternityCode({
		createIfNotExist,
	}: CheckWardMaternityCodeRequest): Observable<boolean>;
	checkWardMaternityCode(
		{ createIfNotExist }: CheckWardMaternityCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<boolean>>;
	checkWardMaternityCode(
		{ createIfNotExist }: CheckWardMaternityCodeRequest,
		...
		return this.request<boolean>(
			{
				url: '/wards/check/maternity/{createIfNotExist}'.replace(
					'{createIfNotExist}',
					encodeURI(createIfNotExist),
				),
				method: 'GET',
				headers,
			},
	...
	getCurrentOccupation({
		code,
	}: GetCurrentOccupationRequest): Observable<number>;
	getCurrentOccupation(
		{ code }: GetCurrentOccupationRequest,
		opts?: OperationOpts,
	...
	getWards(
		opts?: OperationOpts,
	): Observable<Array<WardDTO> | AjaxResponse<Array<WardDTO>>> {
		const headers: HttpHeaders = {};
	...
	getWardsNoMaternity(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<WardDTO>>>;
	getWardsNoMaternity(
		opts?: OperationOpts,
	): Observable<Array<WardDTO> | AjaxResponse<Array<WardDTO>>> {
		const headers: HttpHeaders = {};
	...
	newWard(
		{ wardDTO }: NewWardRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<WardDTO>>;
	newWard(
		{ wardDTO }: NewWardRequest,
		opts?: OperationOpts,
	): Observable<WardDTO | AjaxResponse<WardDTO>> {
