...
export * from './PatVacControllerApi';
export * from './PatientConsensusControllerApi';
export * from './PatientControllerApi';
export * from './PermissionControllerApi';
export * from './PregnantTreatmentTypeControllerApi';
export * from './PriceListControllerApi';
export * from './PricesOthersControllerApi';
