...
import type { VaccineDTO } from '../models';
...
export class VaccinesApi extends BaseAPI {
	...
	getVaccines(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<VaccineDTO>>>;
	getVaccines(
		opts?: OperationOpts,
	): Observable<Array<VaccineDTO> | AjaxResponse<Array<VaccineDTO>>> {
		const headers: HttpHeaders = {};
	...
	getVaccinesByVaccineTypeCode({
		vaccineTypeCode,
	}: GetVaccinesByVaccineTypeCodeRequest): Observable<Array<VaccineDTO>>;
	getVaccinesByVaccineTypeCode(
		{ vaccineTypeCode }: GetVaccinesByVaccineTypeCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<VaccineDTO>>>;
	getVaccinesByVaccineTypeCode(
		{ vaccineTypeCode }: GetVaccinesByVaccineTypeCodeRequest,
		...
		return this.request<Array<VaccineDTO>>(
			{
				url: '/vaccines/type-code/{vaccineTypeCode}'.replace(
					'{vaccineTypeCode}',
					encodeURI(vaccineTypeCode),
				),
				method: 'GET',
				headers,
			},
	...
	newVaccine(
		{ vaccineDTO }: NewVaccineRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<VaccineDTO>>;
	newVaccine(
		{ vaccineDTO }: NewVaccineRequest,
		opts?: OperationOpts,
	): Observable<VaccineDTO | AjaxResponse<VaccineDTO>> {
	...
	updateVaccine(
		{ vaccineDTO }: UpdateVaccineRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<VaccineDTO>>;
	updateVaccine(
		{ vaccineDTO }: UpdateVaccineRequest,
