...
import type { DiseaseDTO } from '../models';
...
export class DiseasesApi extends BaseAPI {
	...
	getAllDiseases(
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DiseaseDTO>>>;
	getAllDiseases(
		opts?: OperationOpts,
	): Observable<Array<DiseaseDTO> | AjaxResponse<Array<DiseaseDTO>>> {
		const headers: HttpHeaders = {};
	...
	getDiseaseByCode(
		{ code }: GetDiseaseByCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DiseaseDTO>>;
	getDiseaseByCode(
		{ code }: GetDiseaseByCodeRequest,
		opts?: OperationOpts,
	): Observable<DiseaseDTO | AjaxResponse<DiseaseDTO>> {
	...
	getDiseases1({
		typecode,
	}: GetDiseases1Request): Observable<Array<DiseaseDTO>>;
	getDiseases1(
		{ typecode }: GetDiseases1Request,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DiseaseDTO>>>;
	getDiseases1(
		{ typecode }: GetDiseases1Request,
		...
		return this.request<Array<DiseaseDTO>>(
			{
				url: '/diseases/both/{typecode}'.replace(
					'{typecode}',
					encodeURI(typecode),
				),
				method: 'GET',
	...
	getDiseasesIpdInByCode({
		typecode,
	}: GetDiseasesIpdInByCodeRequest): Observable<Array<DiseaseDTO>>;
	getDiseasesIpdInByCode(
		{ typecode }: GetDiseasesIpdInByCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DiseaseDTO>>>;
	getDiseasesIpdInByCode(
		{ typecode }: GetDiseasesIpdInByCodeRequest,
		...
		return this.request<Array<DiseaseDTO>>(
			{
				url: '/diseases/ipd/in/{typecode}'.replace(
					'{typecode}',
					encodeURI(typecode),
				),
				method: 'GET',
	...
	getDiseasesIpdOutByCode({
		typecode,
	}: GetDiseasesIpdOutByCodeRequest): Observable<Array<DiseaseDTO>>;
	getDiseasesIpdOutByCode(
		{ typecode }: GetDiseasesIpdOutByCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DiseaseDTO>>>;
	getDiseasesIpdOutByCode(
		{ typecode }: GetDiseasesIpdOutByCodeRequest,
		...
		return this.request<Array<DiseaseDTO>>(
			{
				url: '/diseases/ipd/out/{typecode}'.replace(
					'{typecode}',
					encodeURI(typecode),
				),
				method: 'GET',
	...
	getDiseasesOpdByCode({
		typecode,
	}: GetDiseasesOpdByCodeRequest): Observable<Array<DiseaseDTO>>;
	getDiseasesOpdByCode(
		{ typecode }: GetDiseasesOpdByCodeRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<Array<DiseaseDTO>>>;
	getDiseasesOpdByCode(
		{ typecode }: GetDiseasesOpdByCodeRequest,
		...
		return this.request<Array<DiseaseDTO>>(
			{
				url: '/diseases/opd/{typecode}'.replace(
					'{typecode}',
					encodeURI(typecode),
				),
				method: 'GET',
	...
	updateDisease(
		{ diseaseDTO }: UpdateDiseaseRequest,
		opts?: OperationOpts,
	): Observable<AjaxResponse<DiseaseDTO>>;
	updateDisease(
		{ diseaseDTO }: UpdateDiseaseRequest,
