...
export class LaboratoriesApi extends BaseAPI {
    ...
    deleteExam({ code }: DeleteExamRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    deleteExam({ code }: DeleteExamRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    deleteExamRequest({ code }: DeleteExamRequestRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    deleteExamRequest({ code }: DeleteExamRequestRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    getExamById({ code }: GetExamByIdRequest, opts?: OperationOpts): Observable<AjaxResponse<LaboratoryDTO>>
    getExamById({ code }: GetExamByIdRequest, opts?: OperationOpts): Observable<LaboratoryDTO | AjaxResponse<LaboratoryDTO>> {
    ...
    getExamWithRowsById({ code }: GetExamWithRowsByIdRequest, opts?: OperationOpts): Observable<AjaxResponse<LabWithRowsDTO>>
    getExamWithRowsById({ code }: GetExamWithRowsByIdRequest, opts?: OperationOpts): Observable<LabWithRowsDTO | AjaxResponse<LabWithRowsDTO>> {
    ...
    getLaboratory({ oneWeek, page, size }: GetLaboratoryRequest, opts?: OperationOpts): Observable<AjaxResponse<PageLabWithRowsDTO>>
    getLaboratory({ oneWeek, page, size }: GetLaboratoryRequest, opts?: OperationOpts): Observable<PageLabWithRowsDTO | AjaxResponse<PageLabWithRowsDTO>> {
    ...
    getLaboratory1({ patId }: GetLaboratory1Request, opts?: OperationOpts): Observable<AjaxResponse<Array<LabWithRowsDTO>>>
    getLaboratory1({ patId }: GetLaboratory1Request, opts?: OperationOpts): Observable<Array<LabWithRowsDTO> | AjaxResponse<Array<LabWithRowsDTO>>> {
    ...
    getLaboratoryExamRequest(opts?: OperationOpts): Observable<AjaxResponse<Array<LaboratoryDTO>>>
    getLaboratoryExamRequest(opts?: OperationOpts): Observable<Array<LaboratoryDTO> | AjaxResponse<Array<LaboratoryDTO>>> {
        const headers: HttpHeaders = {
        };
    ...
    getLaboratoryExamRequest1({ patId }: GetLaboratoryExamRequest1Request, opts?: OperationOpts): Observable<AjaxResponse<Array<LaboratoryDTO>>>
    getLaboratoryExamRequest1({ patId }: GetLaboratoryExamRequest1Request, opts?: OperationOpts): Observable<Array<LaboratoryDTO> | AjaxResponse<Array<LaboratoryDTO>>> {
    ...
    getLaboratoryForPrint({ dateFrom, dateTo, examName, patientCode, status, page, size, paged }: GetLaboratoryForPrintRequest, opts?: OperationOpts): Observable<AjaxResponse<PageLabWithRowsDTO>>
    getLaboratoryForPrint({ dateFrom, dateTo, examName, patientCode, status, page, size, paged }: GetLaboratoryForPrintRequest, opts?: OperationOpts): Observable<PageLabWithRowsDTO | AjaxResponse<PageLabWithRowsDTO>> {
    ...
    getMaterials(opts?: OperationOpts): Observable<AjaxResponse<Array<string>>>
    getMaterials(opts?: OperationOpts): Observable<Array<string> | AjaxResponse<Array<string>>> {
        const headers: HttpHeaders = {
        };
    ...
    newExamRequest({ laboratoryDTO }: NewExamRequestRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    newExamRequest({ laboratoryDTO }: NewExamRequestRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    newLaboratory({ labWithRowsDTO }: NewLaboratoryRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    newLaboratory({ labWithRowsDTO }: NewLaboratoryRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    newLaboratory2({ labWithRowsDTO }: NewLaboratory2Request, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    newLaboratory2({ labWithRowsDTO }: NewLaboratory2Request, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    updateExamRequest({ code, status }: UpdateExamRequestRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    updateExamRequest({ code, status }: UpdateExamRequestRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
    ...
    updateLaboratory({ code, labWithRowsDTO }: UpdateLaboratoryRequest, opts?: OperationOpts): Observable<AjaxResponse<boolean>>
    updateLaboratory({ code, labWithRowsDTO }: UpdateLaboratoryRequest, opts?: OperationOpts): Observable<boolean | AjaxResponse<boolean>> {
