...
export const CREATE_DISCHARGE_LOADING = "admissions/CREATE_DISCHARGE_LOADING";
export const CREATE_DISCHARGE_SUCCESS = "admissions/CREATE_DISCHARGE_SUCCESS";
export const CREATE_DISCHARGE_FAIL = "admissions/CREATE_DISCHARGE_FAIL";
export const CREATE_DISCHARGE_RESET = "admissions/CREATE_DISCHARGE_RESET";
