...
export const SEARCH_PATIENT_LOADING = "patients/CREATE_PATIENT_LOADING";
export const SEARCH_PATIENT_SUCCESS = "patients/CREATE_PATIENT_SUCCESS";
export const SEARCH_PATIENT_FAIL = "patients/CREATE_PATIENT_FAIL";
