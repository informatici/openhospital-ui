...
export const GET_PRICELISTS_LOADING = "prices/GET_PRICELISTS_LOADING";
export const GET_PRICELISTS_SUCCESS = "prices/GET_PRICELISTS_SUCCESS";
export const GET_PRICELISTS_FAIL = "prices/GET_PRICELISTS_FAIL";
