...
export default produce(
  (draft: IOperationTypesState, action: IAction<any, any>) => {
    switch (action.type) {
      /**
       * Create vaccine type
       */
      case CREATE_OPERATION_TYPES_LOADING: {
        draft.create.status = "LOADING";
        break;
      }

      case CREATE_OPERATION_TYPES_SUCCESS: {
      ...
      case CREATE_OPERATION_TYPES_FAIL: {
        draft.create.status = "FAIL";
        draft.create.error = action.error;
        break;
      }

      case CREATE_OPERATION_TYPES_RESET: {
       ...
       *  Get vaccine types
       */
      case GET_OPERATION_TYPES_LOADING: {
        draft.getAll.status = "LOADING";
        break;
      }

      case GET_OPERATION_TYPES_SUCCESS: {
      ...
      case GET_OPERATION_TYPES_FAIL: {
        draft.getAll.status = "FAIL";
        draft.getAll.error = action.error;
        break;
      }

      case GET_OPERATION_TYPES_SUCCESS_EMPTY: {
       ...
       * Update vaccine type
       */
      case UPDATE_OPERATION_TYPES_LOADING: {
        draft.update.status = "LOADING";
        delete draft.update.error;
        break;
      }

      case UPDATE_OPERATION_TYPES_SUCCESS: {
      ...
      case UPDATE_OPERATION_TYPES_FAIL: {
        draft.update.status = "FAIL";
        draft.update.error = action.error;
        break;
      }

      case UPDATE_OPERATION_TYPES_RESET: {
       ...
       * Delete vaccine type
       */
      case DELETE_OPERATION_TYPES_LOADING: {
        draft.delete.status = "LOADING";
        delete draft.delete.error;
        break;
      }

      case DELETE_OPERATION_TYPES_SUCCESS: {
      ...
      case DELETE_OPERATION_TYPES_FAIL: {
        draft.delete.status = "FAIL";
        draft.delete.error = action.error;
        break;
      }

      case DELETE_OPERATION_TYPES_RESET: {
