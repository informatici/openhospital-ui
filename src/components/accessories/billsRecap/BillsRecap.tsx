...
import type { IBillSummary } from '../../activities/billingActivity/types';
import type { TFilterValues } from '../billTable/types';
			...
			datasets: [
				{
					...
					data:
						labels.length !== 0
							? labels.map(
									(item) =>
										summaryCurrentYear.paymentsByMonthsOfYear[item] ?? 0,
								)
							: [],
