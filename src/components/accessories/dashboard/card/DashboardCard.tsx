...
import './styles.scss';
import type { TDashboardCardProps } from './types';
...
export const DashboardCard: React.FC<TDashboardCardProps> = ({
	...
	}, [resizeObserver.observe, sizeChangeHandler]);
	...
	useEffect(() => {
		...
		// eslint-disable-next-line react-hooks/exhaustive-deps
	}, [resizeObserver.disconnect, resizeObserver.unobserve, sizeChangeHandler]);
