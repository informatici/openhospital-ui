...
import "./styles.scss";
import { CurrentAdmissionProps } from "./types";

const CurrentAdmission: FC<CurrentAdmissionProps> = ({
  fields,
  onSubmit,
  creationMode,
  submitButtonLabel,
  ...
  return (
    <>
      <div className="patientCurrentAdmission">
        ...
        >
          <div className="row start-sm center-xs">
            <div className="patientCurrentAdmission__item">
              <AutocompleteField
                fieldName="ward"
          ...
          <div className="row start-sm center-xs">
            <div className="fullWidth patientCurrentAdmission__item">
              <AutocompleteField
                fieldName="diseaseIn"
          ...
          <div className="patientCurrentAdmission__buttonSet">
