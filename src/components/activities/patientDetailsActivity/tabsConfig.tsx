...
import PatientTriageForm from "../../accessories/patientTriage/PatientTriage";
...
export const patientDetailTabs: TTabConfig = [
  ...
  { label: "Triage", content: <PatientDetailsContent title="Triage" content={<PatientTriageForm />} /> },
